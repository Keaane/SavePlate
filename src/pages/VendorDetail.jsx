  ...
  useEffect(() => {
    const fetchVendor = async () => {
      ...
      try {
        ...
        // Fetch reviews (new table we just created)
        ...
        // Continue even if reviews table doesn't exist yet
        if (reviewError && !reviewError.message.includes('relation "reviews" does not exist')) {
          throw reviewError;
        }
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <button
              onClick={() => {
                const favorites = JSON.parse(localStorage.getItem('saveplate_favorites') || '[]');
                if (!favorites.includes(vendor.id)) {
                  favorites.push(vendor.id);
                  localStorage.setItem('saveplate_favorites', JSON.stringify(favorites));
                  alert('✅ Vendor saved to favorites!');
                } else {
