  ...
  let imageUrl = formData.imagePreview;
      ...
      if (formData.image && formData.image instanceof File) {
        ...
        try {
          ...
          if (uploadError) {
            // If bucket doesn't exist or permission denied, provide helpful error
            if (uploadError.message.includes('Bucket') || uploadError.message.includes('bucket')) {
              throw new Error('Storage bucket not found. Please create "food-images" bucket in Supabase Storage. See STORAGE_SETUP.md for instructions.');
            }
            throw uploadError;
          }
          ...
          imageUrl = urlData?.publicUrl || urlData || null;
        } catch (storageError) {
